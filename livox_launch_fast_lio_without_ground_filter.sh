...
ros2 bag play simple/ --remap /livox/lidar:=/nonground # use the ground_filter output topic name to skip ground_filter
sleep 10 # optional: wait for 10 secs for screen recording / snapping

kill $lidar_converter_pid $rviz2_pid $fast_lio_pid
